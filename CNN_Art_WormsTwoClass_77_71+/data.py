...
def InlineSkate(cls):
    rate=480        #1882
    train_set_path ="./InlineSkate/InlineSkate_TRAIN"
    test_set_path = "./InlineSkate/InlineSkate_TEST"
    train_data = np.loadtxt(train_set_path, delimiter=',') 
    test_data = np.loadtxt(test_set_path, delimiter=',')
    #train_data = np.array(pd.read_csv(train_set_path,sep='  ', header=None)) #,usecols=range(1,length+1)
    #test_data = np.array(pd.read_csv(test_set_path,sep='  ', header=None)) #,usecols=range(1,length+1)
...
def MiddlePhalanxOutlineCorrect(cls):
    rate=480        #1882
    train_set_path ="./MiddlePhalanxOutlineCorrect/MiddlePhalanxOutlineCorrect_TRAIN"
    test_set_path = "./MiddlePhalanxOutlineCorrect/MiddlePhalanxOutlineCorrect_TEST"
    train_data = np.loadtxt(train_set_path, delimiter=',') 
    test_data = np.loadtxt(test_set_path, delimiter=',')
    #train_data = np.array(pd.read_csv(train_set_path,sep='  ', header=None)) #,usecols=range(1,length+1)
    #test_data = np.array(pd.read_csv(test_set_path,sep='  ', header=None)) #,usecols=range(1,length+1)
...
def MixedShapesSmallTrain(cls):
    rate=480        #1024
    train_set_path ="./MixedShapesSmallTrain/MixedShapesSmallTrain_TRAIN.txt"
    test_set_path = "./MixedShapesSmallTrain/MixedShapesSmallTrain_TEST.txt"
    #train_data = np.loadtxt(train_set_path, delimiter=',') 
    #test_data = np.loadtxt(test_set_path, delimiter=',')
    train_data = np.array(pd.read_csv(train_set_path,sep='  ', header=None)) #,usecols=range(1,length+1)
    test_data = np.array(pd.read_csv(test_set_path,sep='  ', header=None)) #,usecols=range(1,length+1)
...
def MixedShapesSmallTrain0(cls):
    rate=1024        #1024
    train_set_path ="./MixedShapesSmallTrain/MixedShapesSmallTrain_TRAIN.txt"
    test_set_path = "./MixedShapesSmallTrain/MixedShapesSmallTrain_TEST.txt"
    #train_data = np.loadtxt(train_set_path, delimiter=',') 
...
def ProximalPhalanxOutlineCorrect(cls):
    rate=480        #81
    train_set_path ="./ProximalPhalanxOutlineCorrect/ProximalPhalanxOutlineCorrect_TRAIN"
    test_set_path = "./ProximalPhalanxOutlineCorrect/ProximalPhalanxOutlineCorrect_TEST"
    train_data = np.loadtxt(train_set_path, delimiter=',') 
    test_data = np.loadtxt(test_set_path, delimiter=',')
    #train_data = np.array(pd.read_csv(train_set_path,sep='  ', header=None)) #,usecols=range(1,length+1)
    #test_data = np.array(pd.read_csv(test_set_path,sep='  ', header=None)) #,usecols=range(1,length+1)
...
def Strawberry(cls):
    rate=480        #234
    train_set_path ="./Strawberry/Strawberry_TRAIN"
    test_set_path = "./Strawberry/Strawberry_TEST"
    train_data = np.loadtxt(train_set_path, delimiter=',') 
    test_data = np.loadtxt(test_set_path, delimiter=',')
    #train_data = np.array(pd.read_csv(train_set_path,sep='  ', header=None)) #,usecols=range(1,length+1)
    #test_data = np.array(pd.read_csv(test_set_path,sep='  ', header=None)) #,usecols=range(1,length+1)
...
def Worms(cls):
    rate=480        #900
    train_set_path ="./Worms/Worms_TRAIN"
    test_set_path = "./Worms/Worms_TEST"
    train_data = np.loadtxt(train_set_path, delimiter=',') 
    test_data = np.loadtxt(test_set_path, delimiter=',')
    #train_data = np.array(pd.read_csv(train_set_path,sep='  ', header=None)) #,usecols=range(1,length+1)
    #test_data = np.array(pd.read_csv(test_set_path,sep='  ', header=None)) #,usecols=range(1,length+1)
...
def WormsTwoClass(cls):
    rate=480        #900
    train_set_path ="./WormsTwoClass/WormsTwoClass_TRAIN"
    test_set_path = "./WormsTwoClass/WormsTwoClass_TEST"
    train_data = np.loadtxt(train_set_path, delimiter=',') 
    test_data = np.loadtxt(test_set_path, delimiter=',')
    #train_data = np.array(pd.read_csv(train_set_path,sep='  ', header=None)) #,usecols=range(1,length+1)
    #test_data = np.array(pd.read_csv(test_set_path,sep='  ', header=None)) #,usecols=range(1,length+1)
