...
def EcgTwoLead(cls):
    train_set_path = cwd+"/TwoLeadECG/TwoLeadECG_TRAIN.txt"
    test_set_path = cwd+"/TwoLeadECG/TwoLeadECG_TEST.txt"
    train_data = pd.read_csv(train_set_path,sep='  ', header=None) #,usecols=range(1,length+1)
    test_data = pd.read_csv(test_set_path,sep='  ', header=None) #,usecols=range(1,length+1)
