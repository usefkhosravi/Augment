...
def MITBIH(clss):
    if clss==1:
        os.chdir(cwd+'/ECG signals (1000 fragments)/MLII/1 NSR')
        ...
        os.chdir(cwd+'/ECG signals (1000 fragments)/MLII/2 APB')
        # Get a list for .mat files in current folder
        mat_files = glob.glob('*.mat')
        ...
        os.chdir(cwd+'/ECG signals (1000 fragments)/MLII/3 AFL')
        # Get a list for .mat files in current folder
        mat_files = glob.glob('*.mat')
        ...
        os.chdir(cwd+'/ECG signals (1000 fragments)/MLII/4 AFIB')
        # Get a list for .mat files in current folder
        mat_files = glob.glob('*.mat')
        ...
        os.chdir(cwd+'/ECG signals (1000 fragments)/MLII/5 SVTA')
        # Get a list for .mat files in current folder
        mat_files = glob.glob('*.mat')
        ...
        os.chdir(cwd+'/ECG signals (1000 fragments)/MLII/6 WPW')
        # Get a list for .mat files in current folder
        mat_files = glob.glob('*.mat')
        ...
        os.chdir(cwd+'/ECG signals (1000 fragments)/MLII/7 PVC')
        # Get a list for .mat files in current folder
        mat_files = glob.glob('*.mat')
        ...
        os.chdir(cwd+'/ECG signals (1000 fragments)/MLII/8 Bigeminy')
        # Get a list for .mat files in current folder
        mat_files = glob.glob('*.mat')
        ...
        os.chdir(cwd+'/ECG signals (1000 fragments)/MLII/9 Trigeminy')
        # Get a list for .mat files in current folder
        mat_files = glob.glob('*.mat')
        ...
        os.chdir(cwd+'/ECG signals (1000 fragments)/MLII/10 VT')
        # Get a list for .mat files in current folder
        mat_files = glob.glob('*.mat')
        ...
        os.chdir(cwd+'/ECG signals (1000 fragments)/MLII/11 IVR')
        # Get a list for .mat files in current folder
        mat_files = glob.glob('*.mat')
        ...
        os.chdir(cwd+'/ECG signals (1000 fragments)/MLII/12 VFL')
        # Get a list for .mat files in current folder
        mat_files = glob.glob('*.mat')
        ...
        os.chdir(cwd+'/ECG signals (1000 fragments)/MLII/13 fusion')
        # Get a list for .mat files in current folder
        mat_files = glob.glob('*.mat')
        ...
        os.chdir(cwd+'/ECG signals (1000 fragments)/MLII/14 LBBBB')
        # Get a list for .mat files in current folder
        mat_files = glob.glob('*.mat')
        ...
        os.chdir(cwd+'/ECG signals (1000 fragments)/MLII/15 RBBBB')
        # Get a list for .mat files in current folder
        mat_files = glob.glob('*.mat')
        ...
        os.chdir(cwd+'/ECG signals (1000 fragments)/MLII/16 SDHB')
        # Get a list for .mat files in current folder
        mat_files = glob.glob('*.mat')
        ...
        os.chdir(cwd+'/ECG signals (1000 fragments)/MLII/17 PR')
        # Get a list for .mat files in current folder
        mat_files = glob.glob('*.mat')
